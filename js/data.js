...
const DATA = {
  ...
  meta: {
    ...
    activeCampaigns: [
      {
        ...
        objective: "Compras (BOFU) · fondo de embudo",
        status: "Activa",
        started: "En curso (ABO histórico, adsets activos desde abril–agosto 2026)",
        spend: 31350.32,
        ...
        revenueEst: 185922.4,
        funnel: "BOFU",
        description: "La campaña con mayor peso de inversión de toda la cuenta (69% del presupuesto de Meta). Agrupa el remarketing y la conversión directa: suscripción, lanzamientos y promociones puntuales.",
        adsets: [
          { name: "PROS/RET - Always on - Suscripción always on", spend: 4312.65, purchases: 478, cpa: 9.02, roas: 5.23, reach: 181395, frequency: 8.07, promo: "Suscripción" },
          { name: "PROS/RET(adv+) _Smilados_ugc", spend: 3469.24, purchases: 571, cpa: 6.08, roas: 7.62, reach: 160858, frequency: 8.70, promo: "Smilados (UGC)" },
          { name: "PROS/RET - Always on - Lanzamiento Gazpachito", spend: 2175.73, purchases: 272, cpa: 8.00, roas: 5.72, reach: 112308, frequency: 7.53, promo: "Lanzamiento Gazpachito" },
          { name: "PROS/RET - Always on - Suscripción (IMG)", spend: 6073.71, purchases: 660, cpa: 9.20, roas: 5.38, reach: 196396, frequency: 10.39, promo: "Suscripción" },
          { name: "PROS/RET - Suscripción (always on) - Test", spend: 5023.32, purchases: 334, cpa: 15.04, roas: 3.01, reach: 147336, frequency: 12.37, promo: "Suscripción" },
          { name: "PROS/RET - Lanzamiento SMILOTES - Julio", spend: 3284.78, purchases: 376, cpa: 8.74, roas: 5.19, reach: 130252, frequency: 8.68, promo: "Lanzamiento Smilotes" },
          { name: "PROS/RET - Lanzamiento SMILEAT KIDS", spend: 257.32, purchases: 51, cpa: 5.05, roas: 9.35, reach: 26490, frequency: 2.75, promo: "Lanzamiento Smileat Kids" },
          { name: "PROS/RET - Regalo neverita +40€ (junio 2026)", spend: 1359.33, purchases: 345, cpa: 3.94, roas: 11.38, reach: 139785, frequency: 3.05, promo: "Regalo Neverita" },
          { name: "PROS/RET - Regalo neverita +40€ (suscripción)", spend: 2773.52, purchases: 536, cpa: 5.17, roas: 9.16, reach: 124557, frequency: 5.60, promo: "Regalo Neverita" },
          { name: "PROS/RET - 15% Packs y 25% Suscripción", spend: 1362.35, purchases: 192, cpa: 7.10, roas: 7.15, reach: 81819, frequency: 5.11, promo: "15% Packs / 25% Suscripción" },
          { name: "PROS/RET - Cubiertos - Agosto", spend: 1256.47, purchases: 148, cpa: 8.49, roas: 5.25, reach: 95200, frequency: 4.51, promo: "Regalo Cubiertos" }
        ]
      },
      {
        id: "mofu",
        ...
        revenueEst: 25424.34,
        funnel: "MOFU",
        description: "Segunda campaña activa: capta usuarios nuevos con foco en contenido de valor (recetas, dudas sobre tarritos) y remarketing ligero antes de pasar el testigo a BOFU.",
        adsets: [
          { name: "PROS- Broad -All- Collections - dudas tarritos", spend: 0, purchases: 0, cpa: null, roas: null, reach: 0, promo: "Prospección amplia" },
    ...
    promotions: [
      ...
      { name: "Lanzamiento Smilotes", month: "Julio", spend: 3284.78, purchases: 376, roasAvg: 5.19, note: "Lanzamiento de producto con campaña dedicada desde el 14 de julio; mantenida varias semanas tras el lanzamiento." },
      { name: "Regalo Neverita (+40€)", month: "Jun→Jul", spend: 4132.85, purchases: 881, roasAvg: 10.1, note: "La promoción con mejor ROAS de todo julio-agosto. Arrancó en junio y se mantuvo activa hasta finales de julio." },
    ...
    strategyEvolution: [
      ...
      { phase: "Más creatividades, menos frecuencia", detail: "El objetivo declarado es ampliar el volumen de creatividades para poder rotarlas con más frecuencia y bajar así la frecuencia media de impactos por usuario — ver la sección de frecuencia y fatiga." }
    ],
